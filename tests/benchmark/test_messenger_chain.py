"""MESSENGER reproduction — Earth-Earth-Venus-Venus-Mercury-Mercury-Mercury chain, 5 flybys.
First test of the chain solver on a 5-flyby sequence. This is a fidelity-ceiling
...
@pytest.mark.slow
def test_messenger_chain_resolves_self_consistently() -> None:
    ...
    print(
        f"\nMESSENGER chain optimization: converged={result.converged}, "
    ...
    if result.converged:
        ...
        print(
            "MESSENGER chain did not converge within budget at this fidelity "
            "level. This is a legitimate, reportable finding about the limits of "
            "patched-conics chaining over a 5-flyby, multi-year sequence — record "
            "it in docs/validation/messenger_chain_report.md rather than forcing "
