...
SEMI_MAJOR_AXIS_KM: dict[str, float] = {
    "MERCURY": 5.791e7, "VENUS": 1.082e8, "EARTH": 1.496e8, "MARS": 2.279e8,
    "JUPITER": 7.784e8, "SATURN": 1.432e9, "URANUS": 2.867e9, "NEPTUNE": 4.515e9,
}
...
MASS_RATIO: dict[str, float] = {
    ...
    "MARS": 3.227e-7, "JUPITER": 9.545e-4, "SATURN": 2.858e-4,
